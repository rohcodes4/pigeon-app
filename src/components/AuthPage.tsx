...
import { EyeIcon, UserIcon, LockClosedIcon, EyeSlashIcon } from "@heroicons/react/24/outline"; 
...
export const AuthPage = () => {
      ...
      <div className="container mx-auto p-6 flex items-center justify-center min-h-[calc(100vh-80px)] ">
        ...
        >
          <div className="mb-0 flex flex-col items-center justify-center gap-2">
            ...
            <h2
              className={`text-2xl tracking-[1px] text-center text-white`}
            >
              {isSignIn ? "Sign In" : "Create Account"}
            </h2>
          </div>
          <div className="mt-0 mb-10 text-center text-[13px]">
            <p className="text-[#ffffff48]">{isSignIn?"Need an account?":"Already having an account?"}
            <Button
              variant="link"
  ...
  <span className="text-xs text-[#8c8c8c] select-none">
    I accept and agree to all the <a href="/terms" className="text-[#5389ff] underline">Terms & Conditions.</a>
  </span>
</label>
    </div>
  )}
  ...
  <p className="relative z-10 bg-[#111111] text-center text-[13px] text-[#ffffff48] px-4">
    Or continue with
          ...
          <div className="flex items-center justify-center gap-4">
            <Button variant="outline" className="w-max bg-[#212121] text-white hover:bg-blue-700 rounded-[12px] grow">
              <img src={google} alt="google" className="w-5 h-5 object-contain " />              
            </Button>
            <Button variant="outline" className="w-max bg-[#212121] text-white hover:bg-blue-700 rounded-[12px] grow">               
              <img src={telegram} alt="telegram" className="w-5 h-5 object-contain" />              
            </Button>
            <Button variant="outline" className="w-max bg-[#212121] text-white hover:bg-blue-700 rounded-[12px] grow">              
              <img src={discord} alt="discord" className="w-5 h-5 object-contain" />
            </Button>
          </div>
