  ...
  return (
    <aside className="h-[calc(100vh-72px)] overflow-y-scroll overflow-x-hidden min-w-[400px] 2xl:min-w-[500px] bg-[#111111] text-white rounded-2xl flex flex-col shadow-lg border border-[#23242a]">
      ...
      <div className="mb-2 px-2">
        ...
        >
          <span className="text-xs font-[200] text-[#fafafa] leading-none">
            Filtered Streams
          </span>
          {openTab === 0 ? (
        ...
        {openTab === 0 && (
          <div className=" px-2 py-2 rounded-[16px]">
            {filteredTodos
              ...
              .map((todo) => (
                <div
                  className="relative flex  items-start gap-0 mb-2 bg-[#222327] p-2 rounded-[6px] border border-[#ffffff09]"
                  key={todo.id}
