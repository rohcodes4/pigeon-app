...
//   ];
  ...
  const todo = [filteredTodos, favoriteTodos, backlogTodos, filteredTodos, favoriteTodos, backlogTodos]
  ...
  <FaChevronRight size={14} />
      ...
      {TASK_SECTIONS.map((section, index) => (
        <div key={index} className="mb-2 px-2">
          ...
          >
            <span className="text-xs font-[200]" style={{ color: section.textColor }}>
              {section.title}
            </span>
            {openTab === index ? (
