...
const [tasks, setTasks] = useState([...filteredTodos,...favoriteTodos,...backlogTodos]);
...
<div className="relative flex  items-start gap-0 mb-2 bg-[#222327] p-2 rounded-[6px] border border-[#ffffff09]" key={todo.id}
