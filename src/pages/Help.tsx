  ...
  return (
    <Layout>
      <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        />
        <main className="bg-gradient-to-br h-[calc(100vh-72px)] flex pb-0 pr-3 space-x-0 flex max-w-screen justify-stretch border-t border-l border-[#23272f] rounded-tl-[12px] overflow-hidden">
          <div className="flex justify-start flex-col p-6 bg-gradient-to-br from-[#171717] via-[#1a1a1a] to-[#171717] min-h-screen w-full pt-[100px] overflow-y-scroll">
            <div className="max-w-7xl block mx-auto w-full space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <Card className="bg-gradient-to-br from-[#212121] to-[#1a1a1a] border-[#333] hover:border-[#3474ff] transition-all duration-300 hover:shadow-lg hover:shadow-[#3474ff]/20 group">
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-[#ffffff72] text-sm leading-relaxed">
                      Learn the basics of ChatPilot and how to connect your
                      accounts
                    </p>
                    <Button
                      variant="outline"
                ...
                <Card className="bg-gradient-to-br from-[#212121] to-[#1a1a1a] border-[#333] hover:border-[#7B5CFA] transition-all duration-300 hover:shadow-lg hover:shadow-[#7B5CFA]/20 group">
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-[#ffffff72] text-sm leading-relaxed">
                      Discover AI-powered chat summarization and intelligent
                      task extraction
                    </p>
                    <Button
                      variant="outline"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-4 p-6 rounded-xl bg-gradient-to-br from-[#7B5CFA]/10 to-[#7B5CFA]/5 border border-[#7B5CFA]/20 hover:border-[#7B5CFA]/40 transition-all duration-300 group">
                      ...
                      <p className="text-[#ffffff72] text-sm leading-relaxed">
                        ...
                        tasks automatically, and generate insights from your
                        chat history.
                      </p>
                    </div>
                    ...
                    <div className="space-y-4 p-6 rounded-xl bg-gradient-to-br from-[#84afff]/10 to-[#84afff]/5 border border-[#84afff]/20 hover:border-[#84afff]/40 transition-all duration-300 group">
                      ...
                      <p className="text-[#ffffff72] text-sm leading-relaxed">
                        ...
                        conversations and organize them with priorities and
                        tags.
                      </p>
                    </div>
              ...
              {/* Support & Contact */}
              <Card className="bg-gradient-to-br from-[#212121] via-[#1f1f1f] to-[#1a1a1a] border-[#333] hover:border-[#444] transition-all duration-300 !mb-20">
